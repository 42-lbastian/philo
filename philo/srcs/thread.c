...
/*   Updated: 2022/04/15 18:32:00 by lbastian         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	ft_write_status(" is eating\n", id, main_s);
	...
	usleep((main->info_p.time_eat - 1) * 1000);
...
//	ft_write_status(" is sleeping\n", id, main_s);
	...
	gettimeofday(&(main->time_die[id]), NULL);
...
//	{
//		if (ft_get_timedie(main, id) > main->info_p.time_die)
//		{
//			printf("\n\n%d-%d-%d DIE SLEEP\n\n", ft_get_timedie(main, id), ft_get_timestamp(main), id);
//			return (1);
//		}
